...
from price_api.core.models import PriceResult, TokenRef
from price_api.tests.e2e.helpers import (
...
def test_price_endpoint_use_underlying_fails_closed_without_rpc() -> None:
    with TestClient(app) as client:
        response = client.get(
            "/v1/price",
            params={
