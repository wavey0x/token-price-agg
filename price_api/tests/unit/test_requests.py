...
from price_api.api.schemas.requests import PriceRequest, QuoteRequest, TokenRequest

TOKEN = "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"


def test_use_underlying_defaults_false_for_price() -> None:
    req = PriceRequest(chain_id=1, token=TOKEN)
    assert req.use_underlying is False


def test_use_underlying_defaults_false_for_quote() -> None:
